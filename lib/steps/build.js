...
Builder.prototype.getRegistryConfig = function (cb) {
  ...
  return Promise.all({ registryConf: vault.readRegistryPassword(), sshKeyArgs: sshKeyReader.createSSHKeys()})
    .then(function (resp) {
      if (resp.registryConf && resp.registryConf.data && resp.registryConf.data.value) {
        ...
        return { registryConf, sshKeys: resp.sshKeyArgs }
      }
      return resp
    })
    .asCallback(cb)
...
Builder.prototype.runDockerBuild = function (cb) {
  ...
  this.getRegistryConfig(function (err, registryConfAndSShKeys) {
    ...
    if (registryConfAndSShKeys.sshKeys) {
      opts.buildargs = registryConfAndSShKeys.sshKeys
    }
