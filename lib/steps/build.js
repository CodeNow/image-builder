...
Builder.prototype.runDockerBuild = function (cb) {
  ...
  if (process.env.RUNNABLE_BUILD_DOCKER_CONTEXT) {
    opts.context = process.env.RUNNABLE_BUILD_DOCKER_CONTEXT;
  }
...
Builder.prototype._getTarStream = function () {
  var buildRoot = process.env.RUNNABLE_BUILD_DOCKER_CONTEXT ? steps.dirs.repoRoot : this.buildRoot;
