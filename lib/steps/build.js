...
Builder.prototype.runDockerBuild = function (cb) {
  ...
  // From https://docs.docker.com/engine/reference/api/docker_remote_api_v1.22/#/build-image-from-a-dockerfile
  // Path within the build context to the Dockerfile. By default we just generate 'Dockerfile'
  opts.dockerfile = process.env.RUNNABLE_BUILD_DOCKERFILE || 'Dockerfile';
