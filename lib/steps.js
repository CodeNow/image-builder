...
var steps = module.exports = {
  ...
  parseDockerfile: function (cb) {
    ...
    if (runnableBuildDockerfile) {
      ...
      steps.dirs.repoName = repoName;
      steps.dirs.repoRoot = repoRoot;
      steps.dirs.runnableBuildDockerfile = runnableBuildDockerfile;
      ...
      utils.log('Dockefile path:' + steps.dirs.runnableBuildDockerfile)
    }
