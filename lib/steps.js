...
var steps = module.exports = {
  ...
  parseDockerfile: function (cb) {
    ...
    utils.log('Path 1:' + dockerfilePath);
    ...
    if (process.env.RUNNABLE_BUILD_DOCKERFILE) {
      ...
      steps.dirs.buildRoot = path.join(steps.dirs.dockerContext, repoName);
      utils.log('Path 2:' + dockerfilePath);
      utils.log('RepoName:' + repoName);
      utils.log(
        'RUNNABLE_BUILD_DOCKERFILE:' + process.env.RUNNABLE_BUILD_DOCKERFILE
      );
    ...
    utils.log('Path:' + dockerfilePath);
    utils.log('Dockerfile: ' + dockerfile);
    ...
    function saveDockerfile (cb) {
      ...
      utils.log('Save dockerfile', dockerfilePath);
      utils.log('Saved dockerfile', dockerfile);
      cb();
    }
  },
